...
interface KnockoutSubscribableFunctions {
    subscribe(callback: (p)=>void, target?: any, topic?: string): KnockoutSubscription;
    extend(source);
...
interface KnockoutSubscriptionStatic {
    new (target: any, callback: (p)=>void, disposeCallback: ()=>void): KnockoutSubscription;
}
...
interface KnockoutComputedStatic {
    ...
    (): KnockoutComputed;
    (value: ()=>any, context?: any): KnockoutComputed;
    (value: { read: ()=>any; write?: (p)=>void; deferEvaluation?: bool; }): KnockoutComputed;
}
